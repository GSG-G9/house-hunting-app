...
VALUES
  ...
  (5, 2, 'house with 4 rooms', 'Nulla ngilla non. Nullam.', 2, 2, 'appartment', 100, 100),
  (3, 1, 'house with 5 rooms', 'Nulla ngilla non. Nullam.', 5, 3, 'appartment', 150, 200),
  (4, 3, 'house with 6 rooms', 'Nulla ngilla non. Nullam.', 3, 2, 'appartment', 80, 120),
